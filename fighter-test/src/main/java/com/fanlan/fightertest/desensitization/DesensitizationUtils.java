 ...
 *  数据脱敏工具类
 *
 *          String leftPad = StringUtils.leftPad("张", 2, "*");   左边填充
 *         System.out.println(leftPad);
 *         String rightPad = StringUtils.rightPad("张", 2,"*");   右边填充
 *         System.out.println(rightPad);
 *         String center = StringUtils.center("张", 3, "*");      两边填充
 *
 *         *张
 *         张*
 *         *张*
...
public final class DesensitizationUtils {
    ...
    public static String chineseName(String fullName) {
        ...
        return StringUtils.rightPad(name, Integer.valueOf(fullName.length()), "*");
    }
    ...
    public static void main(String[] args) {
        String address = address("北京市昌平区沙河镇", 3);
